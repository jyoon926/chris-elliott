  ...
  return (
    <div className="fade-in">
      <div className='px-3 sm:px-5 mt-14'>
        <h1 className='text-7xl sm:text-8xl font-serif mt-40 mb-20 text-center'>About the Artist</h1>
        <div className="flex flex-col md:flex-row gap-10 justify-center items-center sm:items-start mb-40">
          <img className='w-[200px] sm:w-[300px] bg-gray-100 rounded' src="images/chris-elliott.png" alt="" />
          <div className='flex flex-col items-start text-lg gap-5 max-w-2xl'>
              ...
              <p className="opacity-60">Read an article about a recent exhibition at the Studio Arts Complex in Little Italy <Link className='underline text-blue-600 border-blue-600' to="https://www.sandiegouniontribune.com/2022/12/14/after-her-husbands-death-a-san-diego-widow-wants-to-make-sure-his-artistic-legacy-lives-on/" target="_blank">here</Link>.</p>
            </div>
        </div>
      </div>
      <Footer />
