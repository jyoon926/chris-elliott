  ...
  return (
    <div className="fade-in">
      <div className='px-3 sm:px-5 mt-14'>
        <h1 className='text-7xl sm:text-8xl font-serif mt-40 mb-20 text-center'>About Chris</h1>
        <div className="flex flex-col md:flex-row gap-10 justify-center items-center sm:items-start mb-40">
          <img className='w-[200px] sm:w-[300px] bg-gray-100' src="images/chris-elliott.png" alt="" />
