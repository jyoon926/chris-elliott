        ...
        <form className="w-full">
          <div className="flex flex-row gap-5 text-xl">
            <div className="flex flex-col gap-5">
              <input className="big-input w-[300px]" id="name" type="text" placeholder="Name" required />
              <input className="big-input w-[300px]" id="email" type="text" placeholder="Email" required />
            </div>
